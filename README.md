...
This project currently assumes a Python environment with the required libraries installed.
...
You will also need access to a CLIP model from Hugging Face.

A future version of this README should include a pinned requirements.txt or environment file. Until then, install the dependencies manually in your preferred environment.
